<template>
  <div :style="showInteractive?'':'margin: auto; margin-bottom: 20px;'" class="card">
    <div v-if="showImage" :style="!showInteractive?'':'height: 200px;'" class="card-image">
    ...
    <div class="card-content">
      ...
      <el-tooltip v-if="showImage" effect="light" placement="top">
        ...
        <p style="font-weight: bold;"><a :href="'/detail?id=' + scholarship.id"
                                         target="_blank">{{ scholarship.name }}</a></p>
      </el-tooltip>
      <p v-else style="font-weight: bold;"><a :href="'/detail?id=' + scholarship.id"
                                              target="_blank">{{ scholarship.name }}</a></p>
      ...
      <p>Level: <span v-for="(level, index) in scholarship.levelEntities" :key="level.id"> <span
        v-if="index !=0">, </span><router-link :to="'/level?id='+level.name">{{ level.name }}</router-link></span></p>
    </div>
<!--    <div class="card-footer">-->
<!--      <div v-if="showInteractive" class="card-react">-->
<!--        <div class="card-react&#45;&#45;item">-->
<!--          <el-button circle icon="el-icon-close" @click="close()"></el-button>-->
<!--        </div>-->
<!--        <div class="card-react&#45;&#45;item">-->
<!--          <a :href="'/detail?id=' + scholarship.id">-->
<!--            <el-button circle icon="el-icon-s-promotion" style="color: #FF275A"></el-button>-->
<!--          </a>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
